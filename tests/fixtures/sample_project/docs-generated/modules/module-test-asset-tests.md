...
- Related production/source files: [python_pkg/core.py](../files/file-python-pkg-core-py.md)
...
| related_files | [python_pkg/core.py](../files/file-python-pkg-core-py.md) |
...
| tests/test_core.py | python_pkg/core.py | core, entry:main, python_pkg | true |
