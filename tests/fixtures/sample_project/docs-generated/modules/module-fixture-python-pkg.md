...
| category | file |
| --- | --- |
| source_files | [python_pkg/__init__.py](../files/file-python-pkg-init-py.md) |
...
| --- | --- | --- | --- |
| python_pkg/__init__.py | python_pkg/core.py | core, entry:main, tests | true |
| python_pkg/core.py | python_pkg/helpers.py | entry:main | true |
| tests/test_core.py | python_pkg/core.py | core, entry:main, tests | true |
